...
st.markdown("<h4 style='font-size: 1.2rem; text-align: center; font-weight: 200; line-height: -1rem;'>Analyze and rank applications in seconds!</h4>", unsafe_allow_html=True)
