...
# MAIN USER INTERFACE
st.markdown("<h2 class='h2-title'>HR Resume Screening Assistance Tool</h2>", unsafe_allow_html=True)
st.markdown("<h4 class='h4-subtitle'>Analyze and rank applications in seconds!</h4>", unsafe_allow_html=True)
