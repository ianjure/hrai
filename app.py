...
st.markdown("<h4 style='font-size: 1.2rem; text-align: center; font-weight: 300; margin-top: -0.5rem;'>Analyze and rank job applications in seconds!</h4>", unsafe_allow_html=True)
